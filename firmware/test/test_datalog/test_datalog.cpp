...
void test_datalog_read_exact_match() {
    ...
    // Read exact match
    LogRecord result;
    auto err = testLog->read(1020, &result, 0);
    TEST_ASSERT_FALSE(err);
...
void test_datalog_read_empty_log() {
    ...
    LogRecord result;
    auto err = testLog->read(1000, &result, 0);
...
void test_datalog_search_with_gaps() {
    ...
    LogRecord result;
    auto err = testLog->read(1015, &result, 0);
    TEST_ASSERT_FALSE(err);
...
void test_datalog_search_large_dataset() {
    ...
    LogRecord result;
    auto err = testLog->read(1250, &result, 0);
    TEST_ASSERT_FALSE(err);
...
void test_datalog_search_with_large_gaps() {
    ...
    LogRecord result;
    auto err = testLog->read(5000, &result, 0);
    TEST_ASSERT_FALSE(err);
...
void test_datalog_read_after_wrap() {
    ...
    LogRecord result;
    auto err = testLog->read(1045, &result, 0);
    TEST_ASSERT_FALSE(err);
}
...
void test_datalog_lastCache_hit() {
    ...
    LogRecord result;
    auto err = testLog->read(1070, &result, 0);
    TEST_ASSERT_FALSE(err);
...
void test_datalog_readCache_population() {
    ...
    auto err = testLog->read(1100, &result, 0);
    TEST_ASSERT_FALSE(err);
...
void test_datalog_timestamp_alignment() {    TEST_ASSERT_TRUE(testLog->begin());
    ...
    LogRecord result;
    auto err = testLog->read(1003, &result, 0);
    TEST_ASSERT_FALSE(err);
...
void test_datalog_accumulative_values() {
    ...
    // Read a record
    LogRecord result;
    auto err = testLog->read(1010, &result, 0);
    TEST_ASSERT_FALSE(err);
